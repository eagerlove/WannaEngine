...
namespace WannaEngine {
    void WannaGeometryUtil::CreateCube(float leftPlane, float rightPlane, float bottomPlane, float topPlane, float nearPlane, float farPlane,
                                    std::vector<WannaVertex> &vertices, std::vector<uint32_t> &indices, const bool bUseTextcoords,
